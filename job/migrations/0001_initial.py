    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.CharField(choices=[('No Experience', 'No Experience'), ('One years', 'One Year'), ('Two years', 'Two Year'), ('3 Years above', 'Three Year Plus')], default='No Experience', max_length=20)),
